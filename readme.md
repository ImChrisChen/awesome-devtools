...
* [HTTPeep](https://httpeep.com) - HTTP debugging proxy with unified rule pipeline and file-based config. Charles Proxy, Proxyman Alternative. Support macOS/Windows/Linux.
